//! ISO 32000 Compliance Report Generator
//!
//! Generates a PDF report of the compliance test results
...
fn create_pdf_report(
    ...
    // Main compliance number
    let color = if compliance >= 60.0 {
    ...
    page1
        ...
        .rectangle(50.0, 550.0, 495.0, 100.0)
        .fill();
    ...
    page1.text().at(300.0, 410.0).write("Features")?;

    page1.text().at(370.0, 410.0).write("Implemented")?;

    page1.text().at(470.0, 410.0).write("Compliance")?;
    ...
    // Table data
    let mut y = 390.0;
    for (section, total, implemented, percent) in &sections {
        page1
            .text()
