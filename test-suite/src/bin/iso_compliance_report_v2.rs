//! ISO 32000 Compliance Report Generator V2
//!
//! Generates a professional PDF report with proper layout and colors
...
fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    println!("Generating ISO 32000 Compliance Report V2...");
...
fn create_pdf_report(
    ...
    // Always set black before text
    page1.graphics().set_fill_color(black);
    ...
    page1.graphics().set_fill_color(white);
    page1
        .text()
    ...
    page2.graphics().set_fill_color(black);
    ...
    // What works section - adjusted positioning
    page2
        .graphics()
        .set_fill_color(Color::rgb(0.9, 0.95, 0.9)) // Light green background
        .rectangle(45.0, 490.0, 505.0, 210.0) // Start at 700, go down to 490
        .fill();
    ...
    page2
        ...
        .at(50.0, 680.0) // Inside the green box
    ...
    // Missing features section - properly sized
    page2
        .graphics()
        .set_fill_color(Color::rgb(0.95, 0.9, 0.9)) // Light red background
        .rectangle(45.0, 280.0, 505.0, 190.0) // Start at 470, go down to 280
        .fill();
    ...
    page2
        .text()
        .set_font(Font::HelveticaBold, 14.0)
        .at(50.0, 450.0) // Inside the red box
    ...
    // Comparison box - smaller and with border instead of fill
    page2
        .graphics()
        .set_stroke_color(Color::gray(0.3))
        .set_line_width(2.0)
    ...
    page2.graphics().set_fill_color(Color::rgb(0.7, 0.0, 0.0));
    page2
        .text()
        .at(60.0, 160.0)
