...
use oxidize_pdf_test_suite::{
    TestCorpus, TestCategory,
    spec_compliance::{SpecificationTest, Pdf17ComplianceTester, Pdf20ComplianceTester, test_compliance},
    utils,
};
...
fn test_all_pdf_versions() {
    ...
    for version in versions {
        ...
        if pdf_path.exists() {
            ...
            let header_test = pdf17_results.iter()
