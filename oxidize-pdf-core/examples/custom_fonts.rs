...
fn main() -> Result<()> {
    ...
    page.graphics().set_fill_color(Color::rgb(0.2, 0.2, 0.8));
    ...
    // Subtitle
    page.graphics().set_fill_color(Color::rgb(0.4, 0.4, 0.4));
    ...
    page.graphics().set_fill_color(Color::rgb(0.0, 0.0, 0.0));
