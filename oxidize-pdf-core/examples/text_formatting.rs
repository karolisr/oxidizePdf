use oxidize_pdf_core::{Document, Page, Font, FontFamily, Color};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Title
    page.text().set_font(Font::HelveticaBold, 24.0)
        .at(50.0, 750.0)
    ...
    y -= 25.0;
    page.text().set_font(Font::Helvetica, 18.0)
        .at(50.0, y)
