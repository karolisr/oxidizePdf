...
use oxidize_pdf_core::{Document, Page, Font, Color, graphics::Rectangle};
...
fn mark_semantic_regions(page: &mut Page) {
    ...
    // Mark invoice header
    marker.mark(EntityType::Heading, Rectangle::new(50.0, 740.0, 200.0, 40.0))
        .with_metadata("type", "invoice_header")
        .with_confidence(0.99)
        .build();
    
    // Mark invoice number
    marker.mark_text(Rectangle::new(400.0, 740.0, 150.0, 20.0))
    ...
    // Mark invoice date
    marker.mark_text(Rectangle::new(400.0, 720.0, 150.0, 20.0))
    ...
    // Mark company info
    marker.mark_text(Rectangle::new(50.0, 640.0, 200.0, 60.0))
    ...
    // Mark customer info
    marker.mark_text(Rectangle::new(50.0, 540.0, 200.0, 80.0))
    ...
    // Mark invoice table
    marker.mark_table(Rectangle::new(50.0, 450.0, 500.0, 80.0))
    ...
    // Mark total amount
    marker.mark_text(Rectangle::new(400.0, 390.0, 150.0, 25.0))
