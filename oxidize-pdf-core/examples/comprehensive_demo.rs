use oxidize_pdf_core::{
    Document, Page, Image, Font, Color, Result,
    TextAlign, TextFlowContext
};
...
fn main() -> Result<()> {
    ...
    features_flow.write_paragraph("• Vector graphics: rectangles, circles, lines with stroke and fill")?;
    features_flow.write_paragraph("• Text rendering with multiple fonts (Helvetica, Times, Courier)")?;
