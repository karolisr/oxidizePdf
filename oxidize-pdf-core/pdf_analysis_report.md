# PDF Rendering Analysis Report

Generated: Analysis Report
Total analysis time: 85.12s

## Summary

- **Total PDFs analyzed**: 749
- **Successful**: 543 (72.5%)
- **Parse errors**: 21 (2.8%)
- **Render errors**: 0 (0.0%)
- **Partial errors**: 185 (24.7%)

## Error Categories

| Error Type | Count | Percentage |
|------------|-------|------------|
| PageTreeError | 185 | 24.7% |
| ParseError::Other | 21 | 2.8% |
...
### 12. 20220603 QE Biometrical Consent signed SFM.pdf
- **Size**: 170102 bytes
- **PDF Version**: 1.7
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 1 0 R
...
- **PDF Version**: 2.0
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 8 0 R
...
### 39. CONTRATO PRESTAMO_signed.pdf
- **Size**: 321859 bytes
- **PDF Version**: 1.6
- **Error Type**: PageTreeError
...
### 44. Catrastro 2020 Parcela 62.pdf
- **Size**: 320173 bytes
- **PDF Version**: 1.3
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 1 0 R

### 45. CertificadoPrimas-2021.pdf
- **Size**: 27567 bytes
- **PDF Version**: 1.7
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 1 0 R

### 46. Certificado_20240422367.pdf
- **Size**: 251646 bytes
- **PDF Version**: 2.0
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 14 0 R

### 47. Condiciones_Generales_0007001457142.pdf
- **Size**: 241738 bytes
- **PDF Version**: 1.6
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 1 0 R

### 48. Contrato Comisiones Cuenta SFM.pdf
- **Size**: 185230 bytes
- **PDF Version**: 1.7
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 10 0 R

### 49. Course_Glossary_SUPPLY_LIST.pdf
- **Size**: 10732009 bytes
- **PDF Version**: 1.4
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 1 0 R

### 50. Cyber-Essentials-Requirements-for-Infrastructure-v3-1-January-2023.pdf
- **Size**: 518092 bytes
- **PDF Version**: 1.6
- **Error Type**: PageTreeError
- **Error**: Syntax error at position 0: Circular reference detected: 1 0 R
...
2. **Fix PageTreeError**: Investigate and fix this error category
