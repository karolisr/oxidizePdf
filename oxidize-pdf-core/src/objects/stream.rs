...
mod tests {
    ...
    fn test_set_decode_params() {
        ...
        if let Some(Object::Dictionary(decode_params)) = stream.dictionary().get("DecodeParms") {
            ...
            assert_eq!(decode_params.get("BitsPerComponent"), Some(&Object::Integer(8)));
    ...
    fn test_compress_flate() {
        ...
        let original_data = "Hello, this is a test string that should be compressed! ".repeat(10).into_bytes();
