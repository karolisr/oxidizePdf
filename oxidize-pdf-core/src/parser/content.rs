...
impl ContentParser {
    ...
    fn parse_operator(&mut self, op: &str, operands: &mut Vec<Token>) -> ParseResult<ContentOperation> {
...
mod tests {
    ...
    fn test_tokenize_strings() {
        ...
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::String(b"Hello World".to_vec())));
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::String(b"Hello\nWorld".to_vec())));
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::String(b"Nested (paren)".to_vec())));
    }
    ...
    fn test_tokenize_names() {
        ...
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::Name("ABC".to_string())));
    }
    ...
    fn test_tokenize_operators() {
        ...
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::Operator("Tj".to_string())));
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::Operator("ET".to_string())));
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::Operator("q".to_string())));
        assert_eq!(tokenizer.next_token().unwrap(), Some(Token::Operator("Q".to_string())));
    }
    ...
    fn test_parse_text_operators() {
        ...
        assert_eq!(operators[1], ContentOperation::SetFont("F1".to_string(), 12.0));
        assert_eq!(operators[2], ContentOperation::MoveText(100.0, 200.0));
        assert_eq!(operators[3], ContentOperation::ShowText(b"Hello World".to_vec()));
    ...
    fn test_parse_graphics_operators() {
        ...
        assert_eq!(operators[1], ContentOperation::SetTransformMatrix(1.0, 0.0, 0.0, 1.0, 50.0, 50.0));
        assert_eq!(operators[2], ContentOperation::SetLineWidth(2.0));
        assert_eq!(operators[3], ContentOperation::Rectangle(0.0, 0.0, 100.0, 100.0));
    ...
    fn test_parse_color_operators() {
        ...
        assert_eq!(operators[1], ContentOperation::SetNonStrokingRGB(1.0, 0.0, 0.0));
        assert_eq!(operators[2], ContentOperation::SetNonStrokingCMYK(0.0, 0.0, 0.0, 1.0));
    }
}